...
window.ROCKET_CONFIG = {
  ...
  // Emailed sign-in codes: turn on only after connecting your own email sender (SMTP) in Supabase
  // and putting the code into the Magic Link template. Until then admins hand out temporary passwords.
  emailCodes: false,
