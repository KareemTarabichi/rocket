...
const CACHE = 'rocket-shell-v6';
const SHELL = ['/', '/index.html', '/styles.css', '/config.js', '/js/core.js', '/js/views.js', '/js/views-more.js',
  '/js/admin.js', '/js/live.js', '/js/pwa.js', '/js/ptr.js', '/js/notes.js', '/js/venture.js', '/js/schedules.js', '/js/app.js', '/icons/icon-192.png', '/manifest.webmanifest'];
